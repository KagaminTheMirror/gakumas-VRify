...
The installer merges existing settings and keeps VR configuration separate from Localify. Package metadata and license files remain in the package. Keep the package's license directory when redistributing it. Game assets and translation datasets are not part of this source repository.
